...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("vqlon3ur")
  ...
  // remove
  collection.schema.removeField("6hidtwhb")

  // remove
  collection.schema.removeField("dpyykvlo")

  // remove
  collection.schema.removeField("em1n3qjh")
